...
| Reviewers |3| You've made it to the big time, and the fate of computer graphics rests in your hands. Fill out the SIGGRAPH review form for this paper, decide whether the paper should be accepted or rejected and prepare to make the final decision, with your fellow reviewers, in class. |
